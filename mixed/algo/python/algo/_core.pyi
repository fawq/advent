...
class BoolMatrix:
    def __new__(cls, bound_height:builtins.int, bound_width:builtins.int) -> BoolMatrix: ...
...
class FloatMatrix:
    def __new__(cls, bound_height:builtins.int, bound_width:builtins.int) -> FloatMatrix: ...
...
class IntMatrix:
    def __new__(cls, bound_height:builtins.int, bound_width:builtins.int) -> IntMatrix: ...
...
class StringMatrix:
    def __new__(cls, bound_height:builtins.int, bound_width:builtins.int) -> StringMatrix: ...
